...
//       {/* Main Content */}
//       <div className="flex-1 flex items-center justify-center pt-20"> {/* Add padding-top to account for the fixed navbar */}
...
//     >
//       {/* Navbar */}
//       <div className="w-full bg-gray-800 text-white p-4 flex justify-between items-center shadow-lg fixed z-70">
//         <h1 className="text-2xl font-bold">MeetEase</h1>
//         <button
//           className="bg-blue-500 px-4 py-2 rounded hover:bg-blue-600 flex items-center space-x-2"
//           onClick={handleSignOut}
...
const AvailableRooms = () => {
  ...
  return (
    ...
    >
      ...
      {/* Main Content */}
      <div className="pt-20 p-8"> {/* Add padding-top to account for the fixed navbar */}
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold text-gray-800">Available Rooms</h1>
